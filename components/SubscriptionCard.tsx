...
const SubscriptionCard = ({name, price, currency, billing, icon, color, category, plan, renewalDate, onPress, expanded, paymentMethod, startDate, status}: SubscriptionCardProps) => {
  return (
